//
//  EventAndForemostWidgetConfigurationIntent.swift
//  TodoCalendarApp
//
...
struct EventAndForemostWidgetConfigurationIntent: WidgetConfigurationIntent {

    static let title: LocalizedStringResource = ""

    @Parameter(title: "Style", default: nil)
    var style: EventAndForemostStyleEntity?
