...
템플릿 공통 규칙 — 항목 밖 서술 금지 / 해당 없는 항목은 "없음" 으로 채운다 / 분량 상한은 없다 / 문장은 완결된 자연문으로 쓴다 — 어떤 항목이든 조사·서술어를 갖춰 소리 내 읽으면 말이 되게. 템플릿의 축약 표기(· 나열, — 대시)는 항목 라벨이지 문체 지시가 아니다. 용어(DP·LOE·FRAGO·MOP/MOE·PIR/FFIR)는 템플릿 머리의 용어 줄이 정본이다.
