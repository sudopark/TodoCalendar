...
// MARK: - test more actions

extension EditTodoEventDetailViewModelImpleTests {
    
    // 반복이벤트의 경우 - 추가동작보기 메뉴 구성
    
    // 반복 이벤트의 경우 - 추가 동작 보기 + 이 이벤트만 삭제 - param에 구성
    
    // 반복 이벤트의 경우 - 모든 이벤트 삭제
    
    // 비반복 이벤트의 경우 - 추가 동작보기 메뉴 구성
    
    // TODO: 이벤트 복사하기 => 이벤트 추가 화면으로 이동
